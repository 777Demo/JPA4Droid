 ...
 * <code>AssociationOverride</code> is applied to the entity class.
 * 
 * <p>
 ...
 * embedded within another embeddable class), <code>AssociationOverride</code> is applied to the field or property containing the
 * embeddable.
 * 
 * <p>
 * When <code>AssociationOverride</code> is used to override a relationship mapping from an embeddable class, the <code>name</code> element
 ...
 * embedding, a dot (".") notation syntax must be used in the <code>name</code> element to indicate an attribute within an embedded
 ...
 * 
 * <p>
 * When <code>AssociationOverride</code> is applied to override the mappings of an embeddable class used as a map value, "
 * <code>value.</code>" must be used to prefix the name of the attribute within the embeddable class that is being overridden in order to
 * specify it as part of the map value.
 * 
 * <p>
 * If the relationship mapping is a foreign key mapping, the <code>joinColumns</code> element is used. If the relationship mapping uses a
 * join table, the <code>joinTable</code> element must be specified to override the mapping of the join table and/or its join columns.
 * 
 * <p>
 * 
 * <pre>
