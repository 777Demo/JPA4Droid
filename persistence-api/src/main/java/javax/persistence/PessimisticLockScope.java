...
/**
 * Defines the values of the <code>javax.persistence.lock.scope</code> property for pessimistic locking. This property may be passed as an
...
public enum PessimisticLockScope {
	...
	/**
	 * In addition to the behavior for <code>PessimisticLockScope.NORMAL</code>, element collections and relationships owned by the entity
	 * that are contained in join tables will be locked if the <code>javax.persistence.lock.scope</code> property is specified with a value
	 * of <code>PessimisticLockScope.EXTENDED</code>. The state of entities referenced by such relationships will not be locked (unless
